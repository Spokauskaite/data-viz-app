...
export const addTitle = (ref, titleText) => {
...
export const addDataPointsToScatterPlot = (
  ...
  .enter()
  .append('circle')
  .attr('cx', d => x(d[1][features.x]))
  .attr('cy', d => y(d[1][features.y]))
  .attr('r', r)
  .attr('class', 'circle')
  .style('fill', d => color(d[1][features.group])) 
...
export const addZoomIn = (ref, data, features, x, y, maxX, maxY) => {
  let idleTimeout
  const idleDelay = 350
